...
namespace Dsda.WebUpload.Reports
{
    public partial class DealerSessions : System.Web.UI.Page
    {
        ...
        // ***** For object:
        //       <dx:EntityServerModeDataSource ID="esmDealerSessions" runat="server" ContextTypeName="Dsda.DataAccess.DataClassesDataContext" TableName="tblUploadSessions" OnSelecting="esmDealerSessions_Selecting" OnInit="esmDealerSessions_Init" />
